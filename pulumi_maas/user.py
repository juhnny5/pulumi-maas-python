...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] email: The user e-mail address.
        :param pulumi.Input[str] password: The user password.
        :param pulumi.Input[bool] is_admin: Boolean value indicating if the user is a MAAS administrator. Defaults to `false`.
